...
If you are reading this post you are probably a programmer. You might be a beginner or a professional but most likely you are an imperative programmer. Anyway, welcome, you have made i. You are in the right place to learn about the programming languages principles.

In this post, I’m not going to use any weird greek symbols that mathematicians and computer scientists love to use but I will mostly focus on motivating you why lambda calculus is important and how it layed a strong foundation for functional programming languages like OCaml and Haskell.
